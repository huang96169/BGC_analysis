...
start_datenum=datenum(2014,12,01)+30*7;%Irene
ndays=30;
%dirs
prj_dir='/sciclone/home20/whuang07/schism10/NWM/Case1/RUN06j_ZG/PostP/';  %one level up RUN*

%noaa_obs_dir='/sciclone/home20/whuang07/schism10/NWM/Case1/NOAATIDES/Harvey2017/';
noaa_obs_dir='/sciclone/home20/whuang07/schism10/NWM/Case1/NOAATIDES/OneYear2015/';
...
%   end
%end
output=load([prj_dir '/staout_1_elev']);
elem=output(1+30*7*48:30*7*48+length(time_model),2:151);
dt=1/48;
...
for j=1:10
  ...
  name_fig=strcat(prj_dir,'/Figures','/2DSL-vz0hindelev_',datestr(time_model(1),'yyyymmdd'),'_',datestr(time_model(end),'yyyymmdd'),'_',num2str(j),'.png');
  saveas(gcf,name_fig)
%  savefig(name_fig)
end
...
for j=1:10
  ...
  name_fig=strcat(prj_dir,'/Figures','/2DSL-vz0hindlpelev_',datestr(time_model(1),'yyyymmdd'),'_',datestr(time_model(end),'yyyymmdd'),'_',num2str(j));
