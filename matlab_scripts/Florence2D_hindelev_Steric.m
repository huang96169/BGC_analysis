...
start_datenum=datenum(2021,04,1);%Irene
ndays=35;
%dirs
outname1='RUN07c';
outname2='RUN07c';
prj_dir1=['/sciclone/home20/whuang07/schism10/NWM/Case1/', outname1, '_WH/PostP/'];  %one level up RUN*
prj_dir2=['/sciclone/home20/whuang07/schism10/NWM/Case1/', outname2, '_WH/PostP/'];
...
elem1=output1(1:length(time_model),2:151);
elem2=output2(1:length(time_model),2:151);
dt=1/48;
