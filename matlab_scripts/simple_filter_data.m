...
% e.g. of low-pass: obs_lo=simple_filter_data([time_ha;obs]',1./3,'low'); %3 day cut-off
...
% Alternatively, do forward and backward filters to get rid of phase lag; see exampe_filter.m 
