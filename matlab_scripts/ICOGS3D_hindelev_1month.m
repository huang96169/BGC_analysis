...
for j=1:10
  ...
  name_fig=strcat(prj_dir,'/Figures','/hindelev_',datestr(time_model(1),'yyyymmdd'),'_',datestr(time_model(end),'yyyymmdd'),'_',num2str(j),'.png');
  saveas(gcf,name_fig)
%  savefig(name_fig)
end
...
for j=1:10
  ...
  name_fig=strcat(prj_dir,'/Figures','/hindlpelev_',datestr(time_model(1),'yyyymmdd'),'_',datestr(time_model(end),'yyyymmdd'),'_',num2str(j));
